...
function loadDropdown()
{
	...
	// changes to hide/unhide Top 15 plans link START
	if (currentElementLevel ==2 && parentId !="" &&  document.getElementById("bpDivId"))
	  {
	    document.getElementById("bpDivId").style.visibility="visible";
	    var urlBp=document.getElementById("bpUploadAnId");
	    urlBp=urlBp+"&lobId="+parentId;
	    document.getElementById("bpUploadAnId").href=urlBp;
	    
	    
	    
	  }
	//changes to hide/unhide Top 15 plans link END
	if (parentId!="") {
