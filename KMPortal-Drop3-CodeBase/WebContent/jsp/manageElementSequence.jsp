...
<input type="hidden" name="totalValues" value="" id="totalValues">
	...
	<TD align="center" colspan="3" valign="top"  style="word-wrap: break-word;"><FONT color="red">Element sequence updated successfully!!</FONT></td>
		 ...
		 <tr style="font-size:12px;font-weight:bold;">
			...
			<html:option value="<%=listDto.getElementId()%>"><%=listDto.getElementName() %></html:option>
			</logic:iterate>
			</html:select>
	...
	{
	%>
	<input readonly="readonly" type="text" id="<bean:write name="listDto" property="elementId"/>" value="<bean:write name="listDto" property="sequenceNo"/>"></td>
	<%
	}
	else
	{
