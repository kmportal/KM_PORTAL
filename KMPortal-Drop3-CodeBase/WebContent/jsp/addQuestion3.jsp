...
function formValidate()
{
	...
	document.forms[0].methodName.value = "createQuestion3";
...
<html:form action="/kmBriefingMstr">
	...
	<TABLE align="center"> 
		...
		<li class="clearfix">
			<span class="text2 fll width160"><strong>Question 3<font color=red>*</font></strong></span>
		...
		<li class="clearfix">
		<a  href="./kmBriefingMstr.do?methodName=addQuestion4"><storng><font size="3" color="red"><u>Add More Questions</u></font></storng></a>
