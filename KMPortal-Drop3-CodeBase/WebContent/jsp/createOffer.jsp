 ...
 function validate()
 {
    ...
    if("" == document.forms[0].bucketId.value)
	{
	 ...
	 return false;	
		...
		else if(document.forms[0].startDate.value < curr_dt)
		{
			alert("Bucket Start Date cannot be a past date (day before today).");
			return false;			
		...
		else if(document.forms[0].endDate.value < curr_dt)
		{
			alert("Bucket End Date cannot be a past date (day before today).");
			return false;			
		}
...
<html:form action="/offerUpload"  >
	...
	<html:hidden property="bucketDesc" value=""/>
      ...
      <div class="box2">
        <div class="content-upload">
          ...
          <li class="clearfix alt">
          	...
          	<html:text property="startDate" styleClass="tcal calender2 fll" readonly="true" />
			<span class="text2 fll width160" style="margin-left: 150px;"><strong>Bucket End Date<font color=red>*</font></strong> </span>
			<html:text property="endDate"  styleClass="tcal calender2 fll" readonly="true" />
          </li>                 
          ...
          <li class="clearfix alt">
            ...
            <p class="clearfix fll margin-r20"> <span class="textbox6"> <span class="textbox6-inner">
                <html:text styleClass="textbox10" property="offerTitle" />
                </span> </span> </p>
          </li>
          <li class="clearfix">
      ...
      <div class="button-area">
            <div class="button">
              <input class="submit-btn1 red-btn" name="" value="" onclick="javascript:return submitForm();" />
            </div>
