...
<html:form action="/kmQuizReport">
	...
	<li class="clearfix">
	<span class="text2 fll width160"><strong><font size="4"> Report :</font></strong> </span>	

	<a  href="./kmQuizReport.do?methodName=importExcel"><storng><font size="3" color="red" ><img src="images/excel.gif" width="39" height="35" border="0"/></font></storng></a> 
	</li><logic:empty name="QUIZ_REPORT">
	<tr><TD class="text" align="center" colspan="11" ><font size="4" color="red"><bean:message
				
					key="quiz.report" /></font></TD></tr><br/><br/>
	
	</logic:empty>
				<logic:notEmpty name="QUIZ_REPORT" >
			<bean:define id="reportList" name="QUIZ_REPORT" type="java.util.ArrayList" scope="request"  />
		</logic:notEmpty>	
	      ...
	      <div class="content-upload clearfix">
	       <div class="content-table-type2 clearfix">
			...
			<TR >
                ...
                <TH width="10%" align="left" valign="top">Ud_id</TH>
			...
			<logic:iterate name="reportList" type="com.ibm.km.dto.QuizReportDto" id="report" indexId="i">
			 <!--  String cssName = ""; if( i%2==1){cssName = "alt";}%> -->
				<TR ><!-- class="=cssName%>"> -->	
					...
					<TD class="txt" width="18%" align="left" valign="top"  style="font-size:12px;" ><bean:write name="report" property="wrong_answers"  /></TD>
					<TD class="txt" width="18%" align="left" valign="top"  style="font-size:12px;" ><bean:write name="report" property="skipQuesions"  /></TD>
