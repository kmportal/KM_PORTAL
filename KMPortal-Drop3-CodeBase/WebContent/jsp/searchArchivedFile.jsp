...
function listFiles(){
	...
	var circleId=document.kmDocumentMstrForm.initialSelectBox.value;
	
	$id("parentId").value=parentId;
	$id("elementLevel").value=parseInt(parentLevel)+1;
	document.forms[0].methodName.value="viewArchivedFile";
...
<html:form action="/documentAction" >
	...
	<div class="box2">
        ...
        <h1><bean:message key="viewAllFiles.viewArchivedFiles" /></h1>
	<table width="100%" class="mTop30" align="center">
            ...
            <tr align="center">
				...
				<table id="table_0">
					...
					<tr align="center">
							<td width="636" class="pTop2" colspan="2"><input type="image" src="images/submit.jpg" onclick="return listFiles();"/></td>
					</tr>
					<tr>
	...
	<table width="100%" class="mLeft5" align="center">
		<tr class="lightBg">
		  ...
		  <td  align="left" ><B><FONT size="2">Search Result for :  &nbsp;&nbsp;&nbsp;<bean:write name="kmDocumentMstrForm" property="elementPath" /></FONT></B>
		...
		<tr>
			...
			<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;" height="35"><span class="mLeft5 mTop5"><bean:message
			...
			<td  style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;" height="35"><span class="mLeft5 mTop5"><bean:message
				key="viewAllFiles.publishing_end_dt" /></span></td>
		...
		<logic:notEmpty name="documentList" >
			<logic:iterate name="documentList" type="com.ibm.km.dto.KmDocumentMstr" id="report" indexId="i">
				<tr  align="left"  >
					...
					<TD   align="left" width="4%"><span class="mLeft5 mTop5 mBot5"><%=(i.intValue() + 1)%>.</span></TD>
					<TD   align="left" width="23%"><span class="mLeft5 mTop5 mBot5"><A HREF='documentAction.do?methodName=downloadDocument&docID=<bean:write name="report" property="documentId"/>' class="Red11" ><bean:write name="report"
						property="documentDisplayName" /></A></span></TD>
					<TD   align="left" width="23%"><span class="mLeft5 mTop5 mBot5"><TEXTAREA readonly="readonly" rows="3" cols="30"><bean:write name="report"
						property="documentStringPath" /></TEXTAREA></span></TD>
					<TD   align="left" width="17%"><span class="mLeft5 mTop5 mBot5"><bean:write name="report"
						property="publishingEndDate" /></span></TD>
