	...
	<div class="content-upload">
	 ...
	 <div class="bill-upload-head2 box3 form1">
		<ul class="list2 clearfix">
              ...
              <span class="text5 fll" style="margin-right:36px;"><strong><bean:message key="product.upload.topic"/></strong></span>
              ...
              <span class="text5 fll" style="margin-right:9px;"><strong><bean:message key="rc.value"/></strong></span>
          ...
          <div class="box1 header1">
            <ul class="list1 clearfix">
              <li style="width:345px;">Header</li>
              <li>Value</li>
            </ul>
          </div>
