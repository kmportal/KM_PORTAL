...
public ArrayList<HashMap<String, String>> getRcDataCsr(String rcValue,String selectedRcCategory,
		String rcType, ArrayList<String> docIdList) throws KmException {
	 KmRcContentUploadDao recharge = new KmRcContentUploadDaoImpl();
	 return recharge.getRcDataCsr(rcValue,selectedRcCategory, rcType, docIdList);
}
