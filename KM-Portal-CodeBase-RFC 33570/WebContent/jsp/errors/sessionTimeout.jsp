    ...
    <td colspan="3" align="center" style="padding-top:20px; text-align:left"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="50%" class="arial11grey" ><p>Your session has been timed out...<br />
          ...
          In 15 seconds, you will be automatically redirected to the home page of <a href="" class="arial11blue"> iPortal Login page</a>.</p>
          <p>&nbsp;</p>
          <p> You can also click on this link: <a href="" class="arial11blue" style="color: blue;"><b>iPortal Login page</b></a>.</p></td>
        </tr>
      <tr>
        <td width="50%">&nbsp;</td>
        </tr>
