...
<html:form action="/kmFeedbackMstr" >
	...
	<html:hidden property="elementLevel" styleId="elementLevel"/>
			...
			<table width="100%" class="mTop10" align="center" cellspacing="0" cellpadding="0">
					<tr align="left">
                   ...
                   <html:select property="initialSelectBox" styleId="initialSelectBox" onchange="javascript:loadDropdown(this);">
					...
					<%-- Added by Atul for feedback report --%>
					<TR>
					
					<td>
					<input type="button" value="FEEDBACK RESPONSE"  onclick="Javascript:viewResponse();">
					</td>
					</TR>
					<%-- Ended by Atul for feedback report --%>
					<TR>
					
					<td>
					<input type="button" value="FEEDBACK RESPONSE ALL"  onclick="Javascript:viewResponseAll();">
					</td>
					</TR>
					<tr>
