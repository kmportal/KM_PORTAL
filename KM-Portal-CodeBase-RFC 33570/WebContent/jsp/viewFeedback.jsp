...
<html:form action="/kmFeedbackMstr" >
	...
	<table width="100%" cellspacing="" border="0" style="table-layout: fixed;" >
	 <tr>
	 ...
	 <tr align="left">
      ...
      <tr align="left">
         ...
         <tr align="center">
	            ...
	            <td  class="pTop2" align="center" colspan="8">
   ...
   --><logic:notEqual name="kmFeedbackMstrFormBean" property="initStatus" value="true">	
	   <tr align="right" >
			...
			<td colspan="8"><img  src="images/excel.gif" width="39" height="35" border="0" onclick="importExcel();" /></td>
	   </tr>
	   <tr class="lightBg">
		<td  colspan="8" align="left"><FONT size="2"><B>Search Location : </B></FONT><bean:write name="kmFeedbackMstrFormBean" property="elementFolderPath"/></td></tr>
		
		<tr class="textwhite"  >
		<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x"><bean:message key="feedback.SNO" /> </td>
		<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"><bean:message
				key="feedback.comment" /> </td>	
		<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;">Element Path</td>
		<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"><bean:message
				key="feedback.olm_id" /></td>
			<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"><bean:message
				key="feedback.createdBy" /> </td>
			<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"><bean:message
				key="feedback.createdDt" /></td>
			<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;">Feedback Response </td>
			<td style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;">Action </td>
		...
		<logic:empty name="kmFeedbackMstrFormBean" property="feedbackList">
			...
			<TR class="lightBg">
				<TD  class="error" align="left" colspan="8"><FONT color="red"><bean:message
		...
		<logic:notEmpty name="kmFeedbackMstrFormBean" property="feedbackList">
			<logic:iterate name="kmFeedbackMstrFormBean" id="report" indexId="i" property="feedbackList">
				...
				%>
				<tr class="<%=cssName%>">	
					<TD height="25" class="text">&nbsp;<%=(i.intValue() + 1)%>.</TD>
					<TD class="text" style="word-wrap: break-word  !important;"><bean:write name="report" property="comment" /></TD>
					<TD class="text" style="word-wrap: break-word  !important;"><bean:write name="report" property="feedbackStringPath" />&nbsp;</TD>
					
					<TD class="text"><bean:write name="report" property="olm_id" /></TD>
					
					<TD class="text"><bean:write name="report" property="createdBy" />&nbsp;</TD>
					<TD class="text"><bean:write name="report" property="createdDate" />&nbsp;</TD>
					<%--
				   ...
				   <html:textarea name="kmFeedbackMstrFormBean" styleClass="textarea1" 
						property="feedbackResp" onkeydown="limitText(this,250);" cols="10"></html:textarea></TD> 
				    <%--	 Atul added ended --%>					
					
					
					<%-- Added by Atul for Feedback combo box --%> 
				    <TD class="text" align="center">
					<html:select property="feedbackArray" name="kmFeedbackMstrFormBean" style="width: 95% !important;">
