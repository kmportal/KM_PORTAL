...
//added by vishwas for lob wise upload
 ...
 public ArrayList<KmElementMstr> getAllCircles() throws KmException
 {
	  Connection con;
	    ...
	    {
	        con = DBConnection.getDBConnection();
	        ps = con.prepareStatement(SQL_GET_ALL_CIRCLE_WITH_LOB);
    ...
    throws KmException
{
 ...
 return arraylist;
  ...
  /*  public volatile HashMap getCategoryMapElements(String s, String s1)
    ...
    protected static final String SQL_GET_ALL_CIRCLE_WITH_LOB ="select e.ELEMENT_NAME, e.ELEMENT_ID, e.ELEMENT_LEVEL_ID,l.ELEMENT_Name as LOB from KM_ELEMENT_MSTR as e inner join KM_ELEMENT_MSTR as l on e.parent_id = l.element_id where  e.STATUS = 'A' AND  e.ELEMENT_LEVEL_ID != 0 and e.ELEMENT_LEVEL_ID =3";
