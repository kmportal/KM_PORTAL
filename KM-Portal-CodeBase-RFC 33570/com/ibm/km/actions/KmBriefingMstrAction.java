	...
	**/
	...
	public ActionForward init(
		...
		try {
			...
			kmBriefingMstrFormBean.setFromDate(date);
			kmBriefingMstrFormBean.setToDate(date);
	...
	public ActionForward insert(
		...
		try {
			...
			String csrf= formBean.getCsrf();
			System.out.println("CSRF from session    ----    "+csrfFlag+"      CSRF from formbean    -----    "+csrf);
			if (!csrfFlag.equals(csrf)) {
				System.out.println("CSRF Breach Logout------->");
	...
	private KmBriefingMstr beanToDto(KmBriefingMstrFormBean formBean) {
		...
		dto.setFromDate(formBean.getFromDate());
		dto.setToDate(formBean.getToDate());
