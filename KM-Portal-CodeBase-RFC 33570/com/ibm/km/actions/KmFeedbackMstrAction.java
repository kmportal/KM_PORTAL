	...
	**/
	...
	public ActionForward init(
		...
		throws Exception {
		    ...
		    if((userBean.getUdId()!= null) && (!userBean.getUdId().equals(""))){
		    	olmID= userBean.getUdId();
		    	logger.info("OLM ID from UD :: "+olmID);
		    	
		    }else{
		    	olmID= kmfeedbackMstr.getOLMIDFor(userBean.getUserLoginId());
		    	logger.info("OLMID from DB :: "+olmID);
		    }

			
			formBean.setOlm_id(olmID);
			}
			catch(Exception e){
			...
			throws Exception {
				...
				ActionErrors errors = new ActionErrors();
						...
						try{
									...
									dto.setOlm_id(formBean.getOlm_id());
									KmElementMstrService elementService=new KmElementMstrServiceImpl();
									String[] elementIds=elementService.getChildrenIds(formBean.getParentId());
