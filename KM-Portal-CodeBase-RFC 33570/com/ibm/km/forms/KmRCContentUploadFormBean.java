...
public class KmRCContentUploadFormBean extends ActionForm{
	...
	//Added by ABU for SMS configurable RC data 
	private String mobileNo;
	private String smsStatus;
	private String isConfigurable;
	private String[] configList = null;
	private ArrayList<KmRcCategoryDTO> rcCategoryList = new ArrayList<KmRcCategoryDTO>();
	private String selectedRcCategory = "";
	...
	public void setRcCategoryList(ArrayList<KmRcCategoryDTO> rcCategoryList) {
		this.rcCategoryList = rcCategoryList;
	}
	public ArrayList<KmRcCategoryDTO> getRcCategoryList() {
		return rcCategoryList;
	}
	
	//Added by ABU till here
	...
	public void setSelectedRcCategory(String selectedRcCategory) {
		this.selectedRcCategory = selectedRcCategory;
	}
	public String getSelectedRcCategory() {
		return selectedRcCategory;
	}
