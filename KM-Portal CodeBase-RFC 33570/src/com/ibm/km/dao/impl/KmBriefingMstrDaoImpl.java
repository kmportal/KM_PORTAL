    ...
    implements KmBriefingMstrDao
{
        ...
        throws KmException
    {
        ...
        try
        {
            StringBuffer query = new StringBuffer("INSERT INTO KM_BRIEFING_MSTR (BRIEFING_ID, BRIEFING_HEADING, BRIEFING_DETAILS, CIRCLE_ID, CREATED_BY, CREATED_DT, DISPLAY_DT,CATEGORY_ID) VALUES ( NEXTVAL FOR KM_BRIEFING_ID, ?, ?, ?, ?,  current timestamp, timestamp_format(?, 'YYYY-MM-DD HH24:MI:SS'),?)");
