...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.iconSrc = ICONPATH + "ftv2mnode.gif";
  this.iconSrcClosed = ICONPATH + "plus_icon.gif";
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
	    leftSide = leftSide + "<td style='padding-left:5px;' colspan=2 height=20 valign=middle>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=10 height=10 border=0></a></td>"
    else 
      leftSide = leftSide + "<td style='padding-left:5px;' colspan=2 height=20 valign=middle background=" + ICONPATH + "ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' class=submenutext width=10 height=10 border=0></a></td>"
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "brd_arw.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "minuss.gif"  
      else
        srcStr = ICONPATH + "plus_icon.gif"  
  } 
  else 
  { 
    if (this.nChildren == 0)
...
{ 
  ...
  var fullLink = "href=\""+this.link+"\" target=\""+this.target+"\" ;return false;\"";
  this.isRendered = 1

  if (this.level>0) 
    if (this.isLastNode) //the last 'brother' in the children array 
    { 
      leftSide = leftSide + "<td style='padding-left:5px;' height=30 valign=middle><img src='" + ICONPATH + "brd_arw.gif' width=5 height=5></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td style='padding-left:5px;' height=30 valign=middle background=" + ICONPATH + "ftv2vertline.gif><img src='" + ICONPATH + "brd_arw.gif' width=5 height=5></td>"
    } 
  ...
  if (USETEXTLINKS) 
    docW = docW + "<a onClick=clickOnMyLink("+this.id+") " + fullLink + " id=\"itemTextLink"+this.id+"\">" + this.desc + "</a>"
  else 
    docW = docW + this.desc
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td style='padding-left:5px;' height=30 valign=middle background=" + ICONPATH + "ftv2vertline.gif><img src='" + ICONPATH + "ftv2vertline.gif' width=5 height=5></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td style='padding-left:5px;' height=30 valign=middle><img src='" + ICONPATH + "ftv2blank.gif' width=5 height=5></td>"
		}
	}
	return retStr
}
...
{ 
  ...
  /* KM Phase 2 click to close Added by harpreet */
  else{
   var state
   state=clicked.isOpen
...
function clickOnMyLink(clickedId) {
...
function preLoadIcons() {
	...
	auxImg.src = ICONPATH + "plus_icon.gif";
	auxImg.src = ICONPATH + "plus_icon.gif";
	auxImg.src = ICONPATH + "ftv2blank.gif";
	auxImg.src = ICONPATH + "brd_arw.gif";
	auxImg.src = ICONPATH + "brd_arw.gif";
	auxImg.src = ICONPATH + "plus_icon.gif";
	auxImg.src = ICONPATH + "ftv2mnode.gif";
