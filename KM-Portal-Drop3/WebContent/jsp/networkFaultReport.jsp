...
if(validate())
   ...
   // document.networkFaultReportForm.initialSelectBox.value="3" ;
	...
	document.networkFaultReportForm.methodName.value="fetchNetworkReport"; 
...
function importExcel(){
 $id("parentId").value=parentId;
document.networkFaultReportForm.methodName.value="networkFaultExcelReport";
document.networkFaultReportForm.submit();
}
...
<html:form action="/networkFaultReport" > 
	...
	<html:hidden property="circles" />
		...
		<h1><bean:message key="networkFaultReport.title" /></h1>
		...
		<table width="100%" class="mTop30" align="center">
       	 <tr align="left">
				...
				<logic:present name="superAdmin" scope="request">
						<tr >
							<td>
							<span class="text2 fll width160"><strong><bean:message key="networkFaultReport.select.lob" /> </strong></span>
							</td>
							<td style="width:238px" align="left" class="pBot2"><span class="width150">
							<!--Change start by Vishi   -->
							<html:select property="initialSelectBox" style="width:125px" styleId="initialSelectBox"  onchange="javascript:loadDropdown(event);">
							<!--Change end by Vishi   -->
			...
			<span class="text2 fll width160"><strong><bean:message key="networkFaultReport.report.type" /> </strong></span>&nbsp;&nbsp;
			...
			<div id="dateSelection"><span class="text2 fll" style="margin-right: 103px;"><strong><bean:message key="networkFaultReport.select.date" /> </strong></span>&nbsp;&nbsp;
		...
		<li class="clearfix alt" style="padding-left:170px;">
			<span class="text2 fll">&nbsp;&nbsp;&nbsp;&nbsp;</span><INPUT type="Image" src="images/submit.jpg" onclick="return listUser();"/>
		</li></ul>
...
<table width="100%" class="mTop30" align="center">
	<logic:present name="FAULT_REPORT">	
		<tr align="right" >
		...
		<tr>
			<td  colspan="7" align="left" width="90%"><B><bean:message key="networkFaultReport.search.Location"/> :&nbsp;&nbsp;<bean:write name="networkFaultReportForm" property="elementPath" />
		...
		<logic:present name="superAdmin" scope="request">
			<td
				style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"
				height="30"><span class="mLeft5 mTop5">Circle </span></td>
		</logic:present>		

			<td
				style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"
				height="30"><span class="mLeft5 mTop5">Date<br>(YYYY-MM-DD)</span></td>
			<td
				style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"
				height="30"><span class="mLeft5 mTop5">Time<br>(HH:mm:ss)</span></td>
			<td
				style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"
				height="30"><span class="mLeft5 mTop5">Problem</span></td>
			<td
				style=" background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"
				height="30"><span class="mLeft5 mTop5">Affected Area</span></td>
			<td
				style="background-image:url(./images/left-nav-heading-bg_grey.jpg); background-repeat:repeat-x;"
				height="30"><span class="mLeft5 mTop5">TAT (HH:MM)</span></td>
		</tr>
		
     <logic:notEmpty name="FAULT_REPORT">
     
      <bean:define id="userList" name="FAULT_REPORT" type="java.util.ArrayList" scope="session" />
       
	    <logic:iterate name="userList" id="file" indexId="i" type="com.ibm.km.dto.NetworkFaultReportDto">
		  <TR class="lightBg">
 			<TD width="5%"  align="left"><%=(i.intValue() + 1)%>.</TD>
			<logic:present name="superAdmin" scope="request">		
			  <TD width=10% class="text" align="left"><bean:write
						name="file" property="circleName" /></TD>
			  </logic:present>			
					<TD  width=12%  class="text" align="left"><bean:write
						name="file" property="reportedDate" /></TD>
					<TD width=10%  class="text" align="left"><bean:write
						name="file" property="reportedTime" /></TD>
					<TD class="text" align="left"><TEXTAREA readonly="readonly" rows="4" cols="30"><bean:write
						name="file" property="faultDescription" />
						</TEXTAREA>
						</TD>
					<TD width=30% align="left"><TEXTAREA readonly="readonly" rows="4" cols="35"> <bean:write name="file"
						property="affectedArea" />
						</TEXTAREA>
						</TD>
					<TD width=5%  class="text" align="left"><bean:write
