...
<div id="feedback-tab2" class="feedback-common inner clearfix">
	<table class="table10" cellspacing="5px">
		<thead>
		   	<tr>
		       	<th class="first"><bean:message key="feedback.SNO" /></th>
		           <th class="second">Feedback Comment</th>
		           <th class="third">Feedback Response</th>
		           <th class="fourth">Feedback Created Date </th>
		           <th class="fifth">Feedback Updated Date </th>
		           <th class="sixth">Status(I/R)</th>
	       </tr>
	   </thead>
	</table>
	<div class="table-box">
       <div id="scroll2">
          <div class="scroll-pane">
            <table class="table11"  cellspacing="5px">
            <tbody>
            <logic:notEmpty name="kmFeedbackMstrFormBean" property="feedbackListMy">
				...
				%>
					<tr class="<%=cssName%>">
						<td class="first"><%=(i.intValue() + 1)%>.</TD>
						<td class="second"><bean:write name="feedbackResp" property="comment" /></TD>
						<td class="third"><bean:write name="feedbackResp" property="feedbackResponse" /></TD>
						<td class="fourth"><bean:write name="feedbackResp" property="createdDate" /></TD>
						<td class="fifth"><bean:write name="feedbackResp" property="updatedDate" /></TD>
						<td class="sixth"><bean:write name="feedbackResp" property="readStatus" /></TD>
					</tr>
				</logic:iterate>
			</logic:notEmpty>
            </tbody>
