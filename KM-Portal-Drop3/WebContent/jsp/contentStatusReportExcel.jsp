...
<%
	...
	response.setHeader("content-Disposition",
			"attachment;filename=ContentStatusReport.xls");
%>
</HEAD>
<body >
...
<html:form action="/viewReports" >
	...
	<table width="95%"  align="center">
		...
		<tr>
			...
			<td colspan="9" align="center"><span class="heading"><BR><BR><b>Content Status Report</b><BR><BR></span></td>
		</tr>
		</table>
...
<tr class="textwhite">
			...
			<td style="background-image:url(images/left-nav-heading-bg.jpg); background-repeat:repeat-x;" width="28" height="49" valign="top" align="center"><span class="mLeft5 mTop5"><B><bean:message key="feedback.SNO" /></B></span> </td>
				...
				<td
					style="background-image:url(images/left-nav-heading-bg.jpg); background-repeat:repeat-x;" width="214" height="49" valign="top" align="center"><span class="mLeft5 mTop5"><b>Document Id</b> </span></td>
		...
		<td style="background-image:url(images/left-nav-heading-bg.jpg); background-repeat:repeat-x;" width="223" height="49" valign="top" align="center"><span class="mLeft5 mTop5"><b>Uploaded By</b></span></td>
			...
			<td style="background-image:url(images/left-nav-heading-bg.jpg); background-repeat:repeat-x;" width="214" height="49" valign="top" align="center"><span class="mLeft5 mTop5"><b>Publishing End Date</b></span> </td>
