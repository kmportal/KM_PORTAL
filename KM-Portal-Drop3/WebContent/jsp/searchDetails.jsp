		...
		<logic:notEmpty name="kmDocumentMstrForm" property="searchDetailsList">
			...
			<%	String cssName = "";				
				...
				<tr class="<%=cssName%>"  style="font-size:10px;">	
					...
					<logic:notEqual name="kmDocumentMstrForm" property="actorId" value="1">
						<td align="left" valign="top"  style="word-wrap: break-word">
						<a id="sms" href="/KM/documentAction.do?methodName=sendSMS&keyword=<%=keyword%>&mainOptionValue=<%=mainOption%>&subOptionValue=<%=subOption%>&srno=<bean:write name="listDto" property="srNo" />"onclick='javascript :return validateMobileNumber();'>Send SMS</a></td>
