...
function formValidate()
{
	...
	document.forms[0].methodName.value = "createQuestion2";
...
<html:form action="/kmBriefingMstr">
	...
	<TABLE align="center"> 
		...
		<li class="clearfix">
			<span class="text2 fll width160"><strong>Question 2<font color=red>*</font></strong></span>
		...
		<li class="clearfix">
		<a  href="./kmBriefingMstr.do?methodName=addQuestion3"><storng><font size="3" color="red"><u>Add More Questions</u></font></storng></a>
		</li>
		</c:forEach></TABLE>
		   </div>       
